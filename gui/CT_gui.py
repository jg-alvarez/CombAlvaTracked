...
class Ui_CT_gui(object):
    def setupUi(self, CT_gui):
        ...
        # CT_gui.setWindowIcon(QtGui.QIcon('gui\CT_icon.ico'))
        icon = QtGui.QIcon()
        # icon.addPixmap(QtGui.QPixmap("CT_icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.CharDataTable.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
    ...
    def retranslateUi(self, CT_gui):
        ...
        # CT_gui.setWindowIcon(QtGui.QIcon('CT_icon.ico'))
        # icon = QtGui.QIcon()
        # icon.addPixmap(QtGui.QPixmap("CT_icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        # CT_gui.setWindowIcon(icon)
        ...
        item.setText(_translate("CT_gui", "Initiative"))
        ...
        self.CondDealtComboBox.insertItems(0, ["Normal", "Prone", "Hiden", "Grappled", "Charmed", "Frightened", "Poisoned", "Blind", "Incapacited", "Paralised", "Petrified", "Restrained", "Stunned", "Unconscious", "Invisible", "Deafened", "Stable", "Revived"])
...
import Icon_rc
        ...
        # self.CondTargetComboBox.removeItem()